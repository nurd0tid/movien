...
class BookmarkScreens extends StatefulWidget {
  const BookmarkScreens({super.key});

  @override
  State<BookmarkScreens> createState() => _BookmarkScreensState();
}

class _BookmarkScreensState extends State<BookmarkScreens> {
  @override
